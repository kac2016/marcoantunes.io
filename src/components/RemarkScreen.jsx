...
const ForHomePageContent = (
  <div className="c-remark-screen__message">
    ...
    <p>
      At present, I'm open to <b>full time on-site job</b> offers (New York City).
    </p>
    <p>
      If you realize that I would be a good fit, drop me 
      a message at <b><Obfuscate email='antunesantoniomarco@gmail.com' /></b>.
    </p>
    <p>
...
const ForContactPageContent = (
  <div className="c-remark-screen__message">
    ...
    <p>
      I want you to remember that at present, I am open to <b>full time on-site job</b> offers (New York City).
    </p>
    <p>
